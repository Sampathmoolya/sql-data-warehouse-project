...
> **Note:** The screenshot cuts off after `start_date`, so any additional columns such as `end_date` are not included here.
                 ...
                 gold.dim_customers
                  ...
                  gold.fact_sales
                   ...
                   product_key
                        |
                        |
                 gold.dim_products# Gold Layer Data Catalog
